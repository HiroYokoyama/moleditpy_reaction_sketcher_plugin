    ...
    for item_data in reaction_items:
        ...
        if item_type in ["arrow", "arrow_res", "arrow_eq", "arrow_retro", "arrow_no"]:
            ...
            if item:
                ...
                if "head_size" in item_data: item.head_size = item_data["head_size"]
                if "head_angle" in item_data: item.head_angle = item_data["head_angle"]
                if "head_concavity" in item_data and hasattr(item, "head_concavity"): item.head_concavity = item_data["head_concavity"]
                if "negation_style" in item_data and hasattr(item, "negation_style"): item.negation_style = item_data["negation_style"]
                if "head_style" in item_data and hasattr(item, "head_style"): item.head_style = item_data["head_style"]
            ...
            if "head_size" in item_data: item.head_size = item_data["head_size"]
            if "head_angle" in item_data: item.head_angle = item_data["head_angle"]
            if "head_style" in item_data: item.head_style = item_data["head_style"]
            if "curvature" in item_data: item.curvature = item_data["curvature"]
            item.sync_handles()
            ...
            if "color" in item_data: item.pen_color = QColor(item_data["color"])
            if "width" in item_data: item.pen_width = item_data["width"]
            if "line_style" in item_data: item.line_style = item_data["line_style"]
            item.sync_handles()
            ...
            if "color" in item_data: item.pen_color = QColor(item_data["color"])
            if "size" in item_data: item.set_size(item_data["size"])
            ...
            if "color" in item_data: item.pen_color = QColor(item_data["color"])
            if "width" in item_data: item.pen_width = item_data["width"]
            if "bracket_type" in item_data: item.bracket_type = item_data["bracket_type"]
            if "line_style" in item_data: item.line_style = item_data["line_style"]
            ...
            if "color" in item_data: item.pen_color = QColor(item_data["color"])
            if "width" in item_data: item.pen_width = item_data["width"]
            if "shape_type" in item_data: item.shape_type = item_data["shape_type"]
            if "line_style" in item_data: item.line_style = item_data["line_style"]
